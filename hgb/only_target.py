    ...
    with torch.no_grad():
        ...
        if args.dataset != "Freebase":
            ...
            if args.method == 'herding' or args.method == 'kcenter':
                ...
                torch.save(idx_train_nnd_metapth, f'/home/lyx/HGcond/hgb/idx_train_nnd_{args.dataset}_{args.num_hops}_{args.reduction_rate}_{tgt_type}.pt')                    
                torch.save(score_train_nnd_metapth, f'/home/lyx/HGcond/hgb/score_train_nnd_{args.dataset}_{args.num_hops}_{args.reduction_rate}_{tgt_type}.pt')
                idx_train_nnd_metapth = torch.load(f'/home/lyx/HGcond/hgb/idx_train_nnd_{args.dataset}_{args.num_hops}_{args.reduction_rate}_{tgt_type}.pt')
                score_train_nnd_metapth = torch.load(f'/home/lyx/HGcond/hgb/score_train_nnd_{args.dataset}_{args.num_hops}_{args.reduction_rate}_{tgt_type}.pt')
                idx_selected = []
                score_train_idx_sum = defaultdict(list)
                ...
                # torch.save(ppr_sum, f'/home/lyx/HGcond/hgb/ppr_sum_{args.dataset}_{args.reduction_rate}_{tgt_type}.pt')                    
                # ppr_sum = torch.load(f'/home/lyx/HGcond/hgb/ppr_sum_{args.dataset}_{args.reduction_rate}_{tgt_type}.pt')
                candidate = {}
